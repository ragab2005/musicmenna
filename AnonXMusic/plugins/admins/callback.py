...
async def devs_back(c, query):
    ...
    kb = InlineKeyboardMarkup([[InlineKeyboardButton(text=". Dev¹ .",url="https://t.me/lPlJI"),InlineKeyboardButton(text=". Dev² .",url="https://t.me/Z0HARY")],[InlineKeyboardButton(text=". Back .", callback_data=f"return-developer {query.from_user.id}")],])
    return await query.edit_message_text("‹ Welcome To Brand Source ›\n\n - Dev ↝ @lPlJI\n - Dev ↝@Z0HARY", reply_markup=kb)
