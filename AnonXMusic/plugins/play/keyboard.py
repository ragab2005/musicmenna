...
async def stats_bot(c,msg):
    await msg.reply("• اهلا بك عزيزي المطور بقسم الاحصائيات ◟", reply_markup = ReplyKeyboardMarkup([[("• الجروبات •"), ("• المستخدمين •")], ["• رجوع للقائمة الرئيسية •"]], resize_keyboard=True))
...
async def broadcast_bot(c,msg):
    await msg.reply("• اهلا بك عزيزي المطور بقسم الاذاعه ◟", reply_markup = ReplyKeyboardMarkup([[("• للجروبات •"), ("• للمستخدمين •")], [("• بالتوجيه للجروبات •"), ("• بالتوجيه للمستخدمين •")], [("• ترويج البوت •")], ["• رجوع للقائمة الرئيسية •"]], resize_keyboard=True))
...
async def broadcast_bot_(c,msg):
    try:
        ...
        for chat in chats:
            try:
                await c.send_message(int(chat["chat_id"]),f"• بوت ميوزك قنوات وجروبات ، البوت يعمل بسرعة وجودة خارقة ، بدون تهنيج ولا تقطيع لان البوت شغال علي سيرفر لوحدو◟\n\n• ارفع البوت فـ قناتك او جروبك وجرب سرعة البوت بنفسك وشوف المميزات◟\n\n• يوزر البوت : @{c.me.username} ◟ \n• يوزر المطور : @{owner.username if owner.username else owner.mention} ◟", reply_markup=ikm([[ikb("𓏺 𝖺𝖣𝖣 𝖬𝖾 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈u𝗉𝗌 .", url=f"https://t.me/{app.username}?startgroup=true")]]))
                x += 1
                await asyncio.sleep(0.2)
            except Exception as e:
                pass
        ...
        for chat in users:
            try:
                await c.send_message(int(chat["user_id"]),f"• بوت ميوزك قنوات وجروبات ، البوت يعمل بسرعة وجودة خارقة ، بدون تهنيج ولا تقطيع لان البوت شغال علي سيرفر لوحدو◟\n\n• ارفع البوت فـ قناتك او جروبك وجرب سرعة البوت بنفسك وشوف المميزات◟\n\n• يوزر البوت : @{c.me.username} ◟ \n• يوزر المطور : @{owner.username if owner.username else owner.mention} ◟", reply_markup=ikm([[ikb("𓏺 𝖺𝖣𝖣 𝖬𝖾 𝖳𝗈 𝖸𝗈𝗎𝗋 𝖦𝗋𝗈u𝗉𝗌 .", url=f"https://t.me/{app.username}?startgroup=true")]]))
                x += 1
                await asyncio.sleep(0.2)
            except Exception as e:
                pass
